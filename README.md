...
If you are interested in translating, download the [po file](https://github.com/ecabreral/media-controls/blob/main/assets/locale/media-controls%40ecabreral.github.com.pot) and translate it. Then open a pull request with the translated file. You can use [Gtranslator](https://flathub.org/apps/org.gnome.Gtranslator) or [Poedit](https://flathub.org/apps/net.poedit.Poedit) to translate.
...
<a href="https://github.com/ecabreral/media-controls/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=ecabreral/media-controls" />
</a>
